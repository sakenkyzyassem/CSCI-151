...
### Task 1
 ...
 - Asks a user random numbers until the sum of previous numbers is 100

### Task 2
 
 - Determines whether the given number by the user is prime number or not

### Task 3

 - Finds all prime numbers from a given range of numbers
*/
