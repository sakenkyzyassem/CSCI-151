...
### Task 1
 ...
 - Changes the content of the document 'log.txt' by adding the information user gives: name and age

### Task 2

 - Generates 12 random numbers and finds their minimum, maximum, and average.
